...
<head>
  ...
  <title>Big Time F | S'inscrire</title>
  ...
  <div class="section">
    ...
    <div class="container">
      ...
      <div class="auth-wrapper">
        ...
        <div class="auth-description bg-cover bg-center dark-overlay dark-overlay-2" style="background-image: url('/assetsClients/img/bg-register.jpg')">
